...
if($query)
{
	echo "<script>alert('Successfully Registered. Go to login page to continue');</script>";
  ...
  `date` date(00-00-0000) NOT NULL,
  PRIMARY KEY (`id`)
)"  ;
						if($conn->query($sql)===TRUE){
								echo"Table $fname created successfully";
						}else{
							echo"error creatng table:".$conn->error;
						}
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-register">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span> CoNNeCt</span>. <span>All rights reserved</span>
					</div>
